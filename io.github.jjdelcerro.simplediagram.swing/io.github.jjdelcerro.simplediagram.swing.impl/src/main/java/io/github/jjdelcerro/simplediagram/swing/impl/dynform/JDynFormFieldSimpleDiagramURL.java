...
import org.gvsig.tools.dynform.services.dynformfield.URL.JDynFormFieldURL;
 ...
 * @author jjdelcerro
 */
public class JDynFormFieldSimpleDiagramURL extends JDynFormFieldURL {

    private SimpleDiagramViewer viewer;
    private JComponent fileContents;

    public JDynFormFieldSimpleDiagramURL(
