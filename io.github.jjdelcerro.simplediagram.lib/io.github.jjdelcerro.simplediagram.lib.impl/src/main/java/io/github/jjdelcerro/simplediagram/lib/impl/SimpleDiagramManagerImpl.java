...
public class SimpleDiagramManagerImpl implements SimpleDiagramManager {

  @Override
  public SimpleDiagram createSimpleDiagram(String description) {
    SimpleDiagramImpl x = new SimpleDiagramImpl(description);
    return x;
  }
